...
def createLectureSched(room,subject,sc):
    days = ['M','T','W','TH','F','Sat']
    ...
    print('===================================')
    print('TOTAL LEC Room = ',totalLabRoom)
    print('TOTAL LEC Hours to be consumed (',totalLabRoom,'room x ',maxhours_perday,'hrs x ',len(days),' days) = ',totalHours,' hrs')
    print('TOTAL LEC Subject = ',totalSubject)
